...
async def generate_cover_letter(file: UploadFile = File(...)):
    ...
    query = "generate a short and crisp,resume analysis for the resume content" + text +"using the details given  and give me percentage of the posibilities to get an job on which role"
